...
*   `src/app/api/admin/cleanup/run/route.ts`
*   `src/app/api/admin/cleanup/scan/route.ts`
*   `src/app/api/admin/cleanup-orphaned-users/route.ts`
*   `src/app/api/admin/compliance/alert-schedule/route.ts`
...
*   `src/app/api/kiosk/complete-pairing/route.ts`

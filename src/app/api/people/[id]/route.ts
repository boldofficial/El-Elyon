...
export async function GET() {
	return NextResponse.json(
		{message: 'GET method not implemented for specific resident'},
		{status: 501}
	);
}
...
export async function PUT() {
	return NextResponse.json(
		{message: 'PUT method not implemented for specific resident'},
		{status: 501}
	);
}
...
export async function POST() {
	return NextResponse.json(
		{message: 'POST method not implemented for specific resident'},
		{status: 501}
	);
}
